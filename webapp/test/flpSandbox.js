					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Monitor de Interfaces",
									"targetURL": "#vcmonitor-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"vcmonitor-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vc.monitor",
									"url": sap.ui.require.toUrl("vc/monitor")
								}
							}
						}
					}
